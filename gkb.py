...
#    Jan 28, 2025 03:03:09 PM CST  platform: Linux
...
def _style_code():
    ...
    try:
        gkb_support.root.tk.call(
            "source", os.path.join(_location, "themes", "page-cornsilkdark.tcl")
        )
    except:
        pass
    style = ttk.Style()
...
class Main:
    def __init__(self, top=None):
        ...
        self.LabelStatusTime.configure(
            font="-family {DejaVu Sans} -size 13 -weight bold"
        )
        ...
        self.TLabel9.configure(font="-family {DejaVu Sans} -size 13 -weight bold")
        ...
        self.TLabel2.configure(font="-family {DejaVu Sans} -size 13 -weight bold")
        ...
        self.TLableLogo.configure(font="-family {DejaVu Sans} -size 13 -weight bold")
        ...
        self.Message1.configure(font="-family {DejaVu Sans} -size 13 -weight bold")
...
Copyright © 2023,2024 by Gregory Walters"""
        ...
        self.btnAboutDismiss.place(x=433, y=350, height=28, width=90)
        ...
        self.TLabel3.configure(font="-family {DejaVu Sans} -size 17 -weight bold")
        ...
        self.TLabel6.configure(font="-family {DejaVu Sans} -size 12 -weight bold")
        ...
        self.TLabel5.configure(font="-family {DejaVu Sans} -size 12 -weight bold")
        ...
        self.btnFrameEditDismiss.place(x=860, y=20, height=28, width=90)
        ...
        self.btnEditSave.place(x=730, y=20, height=28, width=90)
        ...
        self.TEntry3.configure(font="-family {DejaVu Sans} -size 12")
        ...
        self.TEntry2.configure(font="-family {DejaVu Sans} -size 12")
        ...
        self.TLabel4.configure(font="-family {DejaVu Sans} -size 12 -weight bold")
        ...
        self.TEntry1.configure(font="-family {DejaVu Sans} -size 12")
        ...
        self.TLabel1.configure(font="-family {DejaVu Sans} -size 12 -weight bold")
        ...
        self.TLabel7.configure(font="-family {DejaVu Sans} -size 12 -weight bold")
        ...
        self.Scrolledtext4.configure(exportselection="0")
        ...
        self.btnSQLDismiss.place(x=870, y=20, height=28, width=90)
        ...
        self.TEntry4.configure(font="-family {DejaVu Sans} -size 12")
    ...
    def popup1(self, event, *args, **kwargs):
        ...
        self.Popupmenu1.add_command(
            command=lambda: gkb_support.on_pop1SelectAll(args),
            compound="left",
        ...
        self.Popupmenu1.add_command(
            command=lambda: gkb_support.on_popCopy(args),
            compound="left",
            font="-family {DejaVu Sans} -size 11 -weight bold",
            label="Copy",
        )
        ...
        self.Popupmenu1.add_command(
            command=lambda: gkb_support.on_popClear(args),
            compound="left",
            font="-family {DejaVu Sans} -size 11 -weight bold",
            label="Clear",
        )
        self.Popupmenu1.add_command(
            command=lambda: gkb_support.on_popPaste(args),
            compound="left",
            font="-family {DejaVu Sans} -size 11 -weight bold",
            label="Paste",
        )
        self.Popupmenu1.add_separator()
        self.Popupmenu1.add_command(
            command=lambda: gkb_support.on_popCloseMenu(args),
            compound="left",
            font="-family {DejaVu Sans} -size 11 -weight bold",
            label="Close Menu",
        )
    ...
    def popup2(self, event, *args, **kwargs):
        ...
        self.Popupmenu2.add_command(
            command=lambda: gkb_support.on_pop2EditTopic(args),
            compound="left",
            font="-family {DejaVu Sans} -size 11 -weight bold",
            label="Edit Topic",
        )
        ...
        self.Popupmenu2.add_command(
            command=lambda: gkb_support.on_pop2DeleteTopic(args),
            compound="left",
            font="-family {DejaVu Sans} -size 11 -weight bold",
            label="Delete Topic",
        )
        self.Popupmenu2.add_separator()
        self.Popupmenu2.add_command(
            command=lambda: gkb_support.on_pop2CloseMenu(args),
            compound="left",
            font="-family {DejaVu Sans} -size 11 -weight bold",
            label="Close Menu",
        )
